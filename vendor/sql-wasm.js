  ...
  initSqlJsPromise = new Promise((resolveModule, reject) => {
    ...
    f.onRuntimeInitialized = () => {
        ...
        switch (typeof l) {
          ...
          case "object":
            if (null === l) ib(g);
              ...
              xa(g, "Wrong API use : tried to return a value of an unknown type (" + l + ").", -1);
            break;
          default:
            ib(g);
        }
      ...
      var h = y(4),
        ...
        z = k("sqlite3_close_v2", "number", ["number"]),
        v = k("sqlite3_exec", "number", ["number", "string", "number", "number", "number"]),
        E = k("sqlite3_changes", "number", ["number"]),
        H = k("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]),
        mb = k("sqlite3_sql", "string", ["number"]),
        oc = k("sqlite3_normalized_sql", "string", ["number"]),
        nb = k("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]),
        pc = k("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]),
        ob = k("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]),
        qc = k("sqlite3_bind_double", "number", ["number", "number", "number"]),
        rc = k("sqlite3_bind_int", "number", ["number", "number", "number"]),
        sc = k("sqlite3_bind_parameter_index", "number", ["number", "string"]),
        tc = k("sqlite3_step", "number", ["number"]),
        uc = k("sqlite3_errmsg", "string", ["number"]),
        vc = k("sqlite3_column_count", "number", ["number"]),
        wc = k("sqlite3_data_count", "number", ["number"]),
        xc = k("sqlite3_column_double", "number", ["number", "number"]),
        pb = k("sqlite3_column_text", "string", ["number", "number"]),
        yc = k("sqlite3_column_blob", "number", ["number", "number"]),
        zc = k("sqlite3_column_bytes", "number", ["number", "number"]),
        Ac = k("sqlite3_column_type", "number", ["number", "number"]),
        Bc = k("sqlite3_column_name", "string", ["number", "number"]),
        Cc = k("sqlite3_reset", "number", ["number"]),
        Dc = k("sqlite3_clear_bindings", "number", ["number"]),
        Ec = k("sqlite3_finalize", "number", ["number"]),
        qb = k(
          "sqlite3_create_function_v2",
          "number",
          "number string number number number number number number number".split(" "),
        ),
        jc = k("sqlite3_value_type", "number", ["number"]),
        mc = k("sqlite3_value_bytes", "number", ["number"]),
        lc = k("sqlite3_value_text", "string", ["number"]),
        nc = k("sqlite3_value_blob", "number", ["number"]),
        kc = k("sqlite3_value_double", "number", ["number"]),
        gc = k("sqlite3_result_double", "", ["number", "number"]),
        ib = k("sqlite3_result_null", "", ["number"]),
        hc = k("sqlite3_result_text", "", ["number", "string", "number", "number"]),
        ic = k("sqlite3_result_blob", "", ["number", "number", "number", "number"]),
        fc = k("sqlite3_result_int", "", ["number", "number"]),
        xa = k("sqlite3_result_error", "", ["number", "string", "number"]),
        rb = k("sqlite3_aggregate_context", "number", ["number", "number"]),
        lb = k("RegisterExtensionFunctions", "number", ["number"]);
      c.prototype.bind = function (g) {
        if (!this.Ka) throw "Statement closed";
        this.reset();
        return Array.isArray(g) ? this.vb(g) : null != g && "object" === typeof g ? this.wb(g) : !0;
      };
      ...
      c.prototype.get = function (g, l) {
        ...
        g = [];
        for (var n = wc(this.Ka), t = 0; t < n; t += 1)
          switch (Ac(this.Ka, t)) {
            case 1: {
      ...
      e.prototype.exec = function (g, l, n) {
        ...
        try {
          ...
          for (g = []; 0 !== m(A, "i8"); ) {
            sa(h);
            sa(N);
            this.handleError(nb(this.db, A, -1, h, N));
            var M = m(h, "i32");
            A = m(N, "i32");
            if (0 !== M) {
              var K = null;
      ...
      e.prototype["export"] = function () {
        Object.values(this.Ya).forEach((l) => {
          l.free();
        });
      ...
      e.prototype.close = function () {
        null !== this.db &&
          (Object.values(this.Ya).forEach((g) => {
            g.free();
          }),
          Object.values(this.Ma).forEach(wa),
          (this.Ma = {}),
      ...
      e.prototype.create_function = function (g, l) {
        Object.hasOwn(this.Ma, g) && (wa(this.Ma[g]), delete this.Ma[g]);
        var n = Aa((t, w, A) => {
          w = b(w, A);
          try {
      ...
      e.prototype.create_aggregate = function (g, l) {
        ...
        Object.hasOwn(this.Ma, g) && (wa(this.Ma[g]), delete this.Ma[g]);
        l = g + "__finalize";
        Object.hasOwn(this.Ma, l) && (wa(this.Ma[l]), delete this.Ma[l]);
        var N = Aa((K, O, Ra) => {
            var Y = rb(K, 1);
            Object.hasOwn(A, Y) || (A[Y] = n());
            O = b(O, Ra);
            O = [A[Y]].concat(O);
            try {
              A[Y] = w.apply(null, O);
    ...
    var Ha = f.print || console.log.bind(console),
      C = f.printErr || console.error.bind(console);
    Object.assign(f, Ba);
    Ba = null;
    ...
    var Q = {
            ...
            (Q.Pa = {
              dir: {
                node: {
                  ...
                  unlink: Q.Fa.unlink,
                  rmdir: Q.Fa.rmdir,
                  readdir: Q.Fa.readdir,
                  symlink: Q.Fa.symlink,
                },
                stream: { Sa: Q.Ga.Sa },
              },
              file: {
                node: { Oa: Q.Fa.Oa, Na: Q.Fa.Na },
                stream: {
                  Sa: Q.Ga.Sa,
                  read: Q.Ga.read,
                  write: Q.Ga.write,
              ...
              link: { node: { Oa: Q.Fa.Oa, Na: Q.Fa.Na, readlink: Q.Fa.readlink }, stream: {} },
              ob: { node: { Oa: Q.Fa.Oa, Na: Q.Fa.Na }, stream: Ab },
            });
          c = Bb(a, b, c, d);
          R(c.mode)
            ? ((c.Fa = Q.Pa.dir.node), (c.Ga = Q.Pa.dir.stream), (c.Ha = {}))
            : 32768 === (c.mode & 61440)
              ? ((c.Fa = Q.Pa.file.node), (c.Ga = Q.Pa.file.stream), (c.La = 0), (c.Ha = null))
              : 40960 === (c.mode & 61440)
                ? ((c.Fa = Q.Pa.link.node), (c.Ga = Q.Pa.link.stream))
                : 8192 === (c.mode & 61440) && ((c.Fa = Q.Pa.ob.node), (c.Ga = Q.Pa.ob.stream));
        ...
        Fa: {
          ...
          Na(a, b) {
            ...
            if (void 0 !== b.size && ((b = b.size), a.La != b))
      ...
      for (var c = Fb, d = "/", e = 0; e < a.length; e++) {
        ...
        if (!h || b.Ra)
          for (h = 0; 40960 === (c.mode & 61440); )
            if (((c = Mb(d)), (d = kb(fb(d), c)), (c = T(d, { jb: b.jb + 1 }).node), 40 < h++))
              throw new P(32);
      }
    ...
    function ja(a) {
      for (var b; ; ) {
        if (a === a.parent)
          return (a = a.Qa.sb), b ? ("/" !== a[a.length - 1] ? `${a}/${b}` : a + b) : a;
        b = b ? `${a.name}/${b}` : a.name;
        a = a.parent;
      }
    }
    ...
    function ma(a, b) {
      a = "string" == typeof a ? T(a, { Ra: !0 }).node : a;
    ...
    var Mc = (a, b) => ((b + 2097152) >>> 0 < 4194305 - !!a ? (a >>> 0) + 4294967296 * b : NaN),
      Nc = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      Oc = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
      Pc = {},
      Rc = () => {
        if (!Qc) {
          var a = {
    ...
    var Vc = {
        a: (a, b, c, d) => {
          G(
            `Assertion failed: ${a ? L(u, a) : ""}, at: ` +
              [
                b ? (b ? L(u, b) : "") : "unknown filename",
                c,
                d ? (d ? L(u, d) : "") : "unknown function",
              ],
          );
        },
        h: (a, b) => {
        ...
        g: (a) => {
          try {
            var b = U(a).node;
            var c = "string" == typeof b ? T(b, { Ra: !0 }).node : b;
        ...
        r: (a, b, c) => {
          try {
            return (
              (b = b ? L(u, b) : ""),
              (b = Ic(a, b)),
              0 === c ? za(b) : 512 === c ? Yb(b) : G("Invalid flags passed to unlinkat"),
              0
            );
          } catch (d) {
            if ("undefined" == typeof W || "ErrnoError" !== d.name) throw d;
        ...
        q: (a, b, c) => {
          try {
            ...
            b = Ic(a, b, !0);
            if (c) {
              var d = F[c >> 2] + 4294967296 * D[(c + 4) >> 2],
                e = D[(c + 8) >> 2];
              h = 1e3 * d + e / 1e6;
              c += 16;
        ...
        l: (a, b, c) => {
          ...
          b = a.getFullYear();
          D[(c + 28) >> 2] =
            ((0 !== b % 4 || (0 === b % 100 && 0 !== b % 400) ? Oc : Nc)[a.getMonth()] +
              a.getDate() -
              1) |
            0;
      ...
      Z = (() => {
        function a(c) {
          ...
          0 == Ua &&
            (null !== Va && (clearInterval(Va), (Va = null)), Wa && ((c = Wa), (Wa = null), c()));
          return Z;
        }
        var b = { a: Vc };
        Ua++;
        ...
        if (f.instantiateWasm)
          try {
            ...
            return C(`Module.instantiateWasm callback failed with error: ${c}`), !1;
          }
        Ya ||= Xa("sql-wasm.wasm")
          ? "sql-wasm.wasm"
          : f.locateFile
            ? f.locateFile("sql-wasm.wasm", B)
            : B + "sql-wasm.wasm";
        bb(b, (c) => {
          a(c.instance);
        });
    ...
    f._sqlite3_create_function_v2 = (a, b, c, d, e, h, k, r, z) =>
      (f._sqlite3_create_function_v2 = Z.wa)(a, b, c, d, e, h, k, r, z);
    f._sqlite3_open = (a, b) => (f._sqlite3_open = Z.xa)(a, b);
    var ia = (f._malloc = (a) => (ia = f._malloc = Z.ya)(a)),
      fa = (f._free = (a) => (fa = f._free = Z.za)(a));
    f._RegisterExtensionFunctions = (a) => (f._RegisterExtensionFunctions = Z.Aa)(a);
    var Eb = (a, b) => (Eb = Z.Ba)(a, b),
      ua = (a) => (ua = Z.Ca)(a),
      y = (a) => (y = Z.Da)(a),
      ra = () => (ra = Z.Ea)();
    f.stackSave = () => ra();
    ...
    function Yc() {
      function a() {
        if (!Wc && ((Wc = !0), (f.calledRun = !0), !Ka)) {
          f.noFSInit ||
            ...
            (f.stdout = f.stdout),
            (f.stderr = f.stderr),
            f.stdin ? Fc("stdin", f.stdin) : Xb("/dev/tty", "/dev/stdin"),
            f.stdout ? Fc("stdout", null, f.stdout) : Xb("/dev/tty", "/dev/stdout"),
            f.stderr ? Fc("stderr", null, f.stderr) : Xb("/dev/tty1", "/dev/stderr"),
            na("/dev/stdin", 0),
            na("/dev/stdout", 1),
            na("/dev/stderr", 1));
          Jb = !1;
      ...
      if (!(0 < Ua)) {
        if (f.preRun)
          for ("function" == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length; ) Ta();
        cb(Pa);
        0 < Ua ||
          (f.setStatus
            ? (f.setStatus("Running..."),
