...
(function _f(self) {
  ...
  else if (typeof process !== "undefined") self = process;
  self._factory = _f;
  var w;
  function H(a, c, b) {
    const e = typeof b,
    ...
    if ("undefined" !== e) {
      if ("undefined" !== d) {
        if (b) {
          if ("function" === d && e === d) return (h) => a(b(h));
          c = a.constructor;
          if (c === b.constructor) {
  ...
  function ca(a) {
    const c = [];
    for (const b of a.keys()) c.push(b);
    return c;
  }
  function ea(a, c) {
    if (M(c)) a = a[c];
  ...
  const fa = /[^\p{L}\p{N}]+/u,
    ...
    ka = /[\u0300-\u036f]/g;
  function la(a = {}) {
    if (!this || this.constructor !== la) return new la(...arguments);
  ...
  w.assign = function (a) {
    ...
    if (b || "" === b) {
      if ("object" === typeof b && b.constructor !== RegExp) {
        ...
        b.punctuation && (d += "\\p{P}");
        b.control && (d += "\\p{C}");
        if ((b = b.char)) d += "object" === typeof b ? b.join("") : b;
        try {
          this.split = new RegExp("[" + (c ? "^" : "") + d + "]+", "u");
        } catch (f) {
          this.split = /\s+/;
        }
      } else (this.split = b), (e = !1 === b || 2 > "a1a".split(b).length);
  ...
  w.addFilter = function (a) {
    "function" === typeof a
      ? (this.filter = a)
      : (this.filter || (this.filter = new Set()), this.filter.add(a));
    this.cache && Q(this);
    return this;
  };
  w.addMapper = function (a, c) {
    if ("object" === typeof a) return this.addReplacer(a, c);
    if (1 < a.length) return this.addMatcher(a, c);
  ...
  w.addMatcher = function (a, c) {
    if ("object" === typeof a) return this.addReplacer(a, c);
    if (2 > a.length && (this.dedupe || this.mapper)) return this.addMapper(a, c);
  ...
  w.addReplacer = function (a, c) {
    if ("string" === typeof a) return this.addMatcher(a, c);
  ...
  w.encode = function (a, c) {
    if (this.cache && a.length <= this.L)
      ...
      } else this.I = setTimeout(Q, 50, this);
    this.normalize &&
      ("function" === typeof this.normalize
        ? (a = this.normalize(a))
        : (a = ka ? a.normalize("NFKD").replace(ka, "").toLowerCase() : a.toLowerCase()));
    this.prepare && (a = this.prepare(a));
    this.numeric &&
      3 < a.length &&
      (a = a.replace(ia, "$1 $2").replace(ja, "$1 $2").replace(ha, "$1 "));
    const b = !(
      this.dedupe ||
      this.mapper ||
      this.filter ||
    ...
    let e = [],
      ...
      f,
      g,
      h = this.split || "" === this.split ? a.split(this.split) : [a];
    for (let m = 0, l, n; m < h.length; m++)
      if ((l = n = h[m]) && !(l.length < this.minlength || l.length > this.maxlength)) {
        ...
        if (b) e.push(l);
          ...
          !this.filter ||
          ("function" === typeof this.filter ? this.filter(l) : !this.filter.has(l))
        ) {
          ...
          if (l && (this.mapper || (this.dedupe && 1 < l.length))) {
            ...
            for (let u = 0, p = "", t, r; u < l.length; u++)
              (t = l.charAt(u)),
                (t === p && this.dedupe) ||
                  ((r = this.mapper && this.mapper.get(t)) || "" === r
                    ? (r === p && this.dedupe) || !(p = r) || (k += r)
                    : (k += p = t));
            l = k;
          }
          this.matcher &&
            1 < l.length &&
            (this.N || (this.N = new RegExp("(" + this.h + ")", "g")),
            (l = l.replace(this.N, (u) => this.matcher.get(u))));
          if (l && this.replacer)
          ...
          this.cache &&
            n.length <= this.M &&
            (this.H.set(n, l),
            this.H.size > this.R && (this.H.clear(), (this.M = (this.M / 1.1) | 0)));
          if (l) {
            if (l !== n)
              if (c) {
                if (d[l]) continue;
    ...
    this.cache &&
      a.length <= this.L &&
      (this.B.set(a, e), this.B.size > this.R && (this.B.clear(), (this.L = (this.L / 1.1) | 0)));
    return e;
  };
  function Q(a) {
    a.I = null;
  ...
  var va = {
    ...
    LatinAdvanced: { mapper: ra, matcher: sa, replacer: ta },
    LatinExtra: { mapper: ra, replacer: ta.concat([/(?!^)[aeo]/g, ""]), matcher: sa },
    LatinSoundex: {
      dedupe: !1,
      include: { letter: !0 },
      finalize: (a) => {
  ...
  function wa(a, c, b, e) {
    ...
    for (let f = 0, g; f < a.index.length; f++)
      if (((g = a.index[f]), c >= g.length)) c -= g.length;
      else {
  ...
  function za(a) {
    if (!this || this.constructor !== za) return new za(a);
    this.index = a ? [a] : [];
    this.length = a ? a.length : 0;
    const c = this;
    return new Proxy([], {
      get(b, e) {
        if ("length" === e) return c.length;
        if ("push" === e)
          return (d) => {
        ...
        if ("slice" === e) return (d, f) => wa(c, d || 0, f || c.length, !1);
        if ("splice" === e) return (d, f) => wa(c, d || 0, f || c.length, !0);
        if ("constructor" === e) return Array;
        if ("symbol" !== typeof e) return (b = c.index[(e / 2 ** 31) | 0]) && b[e];
      },
      set(b, e, d) {
        b = (e / 2 ** 31) | 0;
  ...
  S.prototype.set = function (a, c) {
    ...
    let e = this.index[b];
    e
      ? ((b = e.size), e.set(a, c), (b -= e.size) && this.size++)
      : ((this.index[b] = e = new Map([[a, c]])), this.h.push(e), this.size++);
  };
  function T(a = 8) {
  ...
  T.prototype.add = function (a) {
    ...
    let b = this.index[c];
    b
      ? ((c = b.size), b.add(a), (c -= b.size) && this.size++)
      : ((this.index[c] = b = new Set([a])), this.h.push(b), this.size++);
  };
  w = S.prototype;
  ...
  w.values = T.prototype.values = function* () {
    for (let a = 0; a < this.h.length; a++) for (const c of this.h[a].values()) yield c;
  };
  w.keys = T.prototype.keys = function* () {
    for (let a = 0; a < this.h.length; a++) for (const c of this.h[a].keys()) yield c;
  };
  w.entries = T.prototype.entries = function* () {
    for (let a = 0; a < this.h.length; a++) for (const c of this.h[a].entries()) yield c;
  };
  function Ba(a) {
    const c = 2 ** this.A - 1;
  ...
  function Aa(a) {
    const c = BigInt(2) ** this.A - BigInt(1);
    var b = typeof a;
    if ("bigint" === b) return a & c;
    if ("number" === b) return BigInt(a) & c;
    b = BigInt(0);
    const e = this.A + BigInt(1);
  ...
  async function Ea(a) {
    ...
    switch (c) {
      case "init":
        Da = a.options || {};
        (c = a.factory)
          ? (Function("return " + c)()(self),
            (Ca = new self.FlexSearch.Index(Da)),
      ...
      default: {
        let d;
        "export" === c && (e[1] ? ((e[0] = Da.export), (e[2] = 0), (e[3] = 1)) : (e = null));
        "import" === c
          ? e[0] && ((a = await Da.import.call(Ca, e[0])), Ca.import(e[0], a))
          : ((d = e && Ca[c].apply(Ca, e)) && d.then && (d = await d),
            d && d.await && (d = await d.await),
            "search" === c && d.result && (d = d.result));
  ...
  function Ga(a) {
    this[a + "Async"] = function () {
      ...
      Ha
        ? Ja || (Ja = Date.now() - Ia >= this.priority * this.priority * 3)
        : ((Ha = setTimeout(Ka, 0)), (Ia = Date.now()));
      if (Ja) {
        return new Promise((g) => {
          setTimeout(() => {
            g(this[a + "Async"].apply(this, c));
          }, 0);
        });
      }
  ...
  function La(a = {}, c) {
    ...
    const d = "undefined" === typeof window,
      f = this,
      g = Ma(e, d, a.worker);
    return g.then ? g.then((h) => b.call(f, h)) : b.call(this, g);
  }
  X("add");
  X("append");
  X("search");
  ...
  function X(a) {
    La.prototype[a] = function () {
      ...
      e = new Promise((f) => {
        ...
        1e9 < W && (W = 0);
        this.h[++W] = f;
        this.worker.postMessage({ task: a, id: W, args: b });
      });
  ...
  function Ma(a, c, b) {
    return c
      ? "undefined" !== typeof module
        ...
        : import("worker_threads").then(
            (worker) => new worker["Worker"]((1, eval)("import.meta.dirname") + "/node/node.mjs"),
          )
      : a
        ? new window.Worker(
            URL.createObjectURL(
              new Blob(["onmessage=" + Ea.toString()], { type: "text/javascript" }),
            ),
          )
        : new window.Worker(
            "string" === typeof b
    ...
    if (c && (a || 0 === a)) {
      ...
      for (let h = 0, k; h < this.field.length; h++) {
        ...
        if ("function" === typeof k) {
          ...
          k.constructor === String ? (k = ["" + k]) : M(k) && (k = [k]),
            Oa(c, k, this.K, 0, e, a, k[0], b);
      }
      if (this.tag)
        for (e = 0; e < this.F.length; e++) {
          var f = this.F[e];
          d = this.tag.get(this.P[e]);
          const h = I();
          ...
          if (d && f) {
            ...
            for (let k = 0, m, l; k < f.length; k++)
              if (
                ((m = f[k]),
                !h[m] &&
                  ((h[m] = 1), (g = d.get(m)) ? (l = g) : d.set(m, (l = [])), !b || !l.includes(a)))
              ) {
                if (l.length === 2 ** 31 - 1) {
                  g = new za(l);
                  if (this.fastupdate)
                    for (const n of this.reg.values()) n.includes(l) && (n[n.indexOf(l)] = g);
                  d.set(m, (l = g));
                }
                l.push(a);
      ...
      if (this.store && (!b || !this.store.has(a))) {
        ...
        if (this.D) {
          ...
          for (let k = 0, m; k < this.D.length; k++) {
            m = this.D[k];
            if ((b = m.J) && !b(c)) continue;
            let l;
            if ("function" === typeof m) {
              l = m(c);
              if (!l) continue;
              m = [m.U];
            } else if (M(m) || m.constructor === String) {
              h[m] = c[m];
              continue;
            }
            Ra(c, h, m, 0, m[0], l);
  ...
  function Ra(a, c, b, e, d, f) {
    ...
    if (e === b.length - 1) c[d] = f || a;
      ...
      if (a.constructor === Array)
        for (c = c[d] = Array(a.length), d = 0; d < a.length; d++) Ra(a, c, b, e, d);
  ...
  function Oa(a, c, b, e, d, f, g, h) {
    if ((a = a[g]))
      if (e === c.length - 1) {
        ...
        d.add(f, a, h, !0);
      } else if (a.constructor === Array) for (g = 0; g < a.length; g++) Oa(a, c, b, e, d, f, g, h);
      else (g = c[++e]), Oa(a, c, b, e, d, f, g, h);
  ...
  function Ua(a, c, b, e) {
    ...
    for (c = 0; c < e.length; c++)
      if ((d = e[c])) {
        var p = void 0;
        if (d.constructor === Y) p = d.await || d.result;
        else if (d.then || d.constructor === Array) p = d;
        else {
          g = d.limit || 0;
          h = d.offset || 0;
          l = d.suggest;
          ...
          if (d.query || d.tag) {
            ...
            if (p && (u || a.await)) {
              ...
              (d.resolve = !1),
                (d.index = null),
                (p = t ? n.searchAsync(d) : n.search(d)),
                (d.resolve = m),
                (d.index = n);
          } else if (d.and) p = Va(d, "and", n);
          else if (d.or) p = Va(d, "or", n);
          else if (d.not) p = Va(d, "not", n);
          else if (d.xor) p = Va(d, "xor", n);
          else continue;
        }
        p.await
          ? ((u = 1), (p = p.await))
          : p.then
            ? ((u = 1), (p = p.then((t) => t.result || t)))
            : (p = p.result || p);
        f[c] = p;
      }
    u &&
    ...
    if (u) {
      const t = Promise.all(f).then((r) => {
        for (let q = 0; q < a.C.length; q++)
          if (a.C[q] === t) {
            a.C[q] = () => b.call(a, r, g, h, k, m, l);
            break;
          }
        Wa(a);
      });
      a.C.push(t);
    } else if (a.await) a.C.push(() => b.call(a, f, g, h, k, m, l));
    else return b.call(a, f, g, h, k, m, l);
  ...
  function Xa(a, c, b, e, d) {
    a.length &&
      (this.result.length && a.push(this.result),
      2 > a.length ? (this.result = a[0]) : ((this.result = Ya(a, c, b, !1, this.h)), (b = 0)));
    d && (this.await = null);
  ...
  function Za(a, c, b, e, d, f) {
    ...
    let g;
    if (a.length)
      if ((this.result.length && a.unshift(this.result), 2 > a.length)) this.result = a[0];
      else {
        let h = 0;
        for (let k = 0, m, l; k < a.length; k++)
          if ((m = a[k]) && (l = m.length)) h < l && (h = l);
          else if (!f) {
            h = 0;
            break;
          }
          ...
          for (let l = 0, n; l < a.length; l++)
            if ((n = a[l])) {
              ...
              for (let u = 0, p; u < n.length; u++)
                if ((p = n[u]))
                  for (let t = 0, r; t < p.length; t++) (r = p[t]), (k[r] = k[r] ? 2 : 1);
            }
          ...
          if ((k = this.result[h]))
            for (let l = 0, n; l < k.length; l++)
              if (((n = k[l]), !a.has(n)))
                ...
                } else if ((g[h] || (g[h] = []), g[h].push(n), ++m === c)) {
                  a = g;
                  break a;
                }
        a = g;
  ...
  function Y(a, c) {
    if (!this || this.constructor !== Y) return new Y(a, c);
    let b = 0,
      e,
      d,
      f;
    ...
    if (a && a.then) {
      a = a.then((h) => {
        this.C[0] = this.result = h.result || h;
        Wa(this);
      });
      e = [a];
      a = [];
  ...
  Y.prototype.offset = function (a) {
    if (this.result.length) {
      const c = [];
      for (let b = 0, e; b < this.result.length; b++)
        if ((e = this.result[b])) e.length <= a ? (a -= e.length) : ((c[b] = e.slice(a)), (a = 0));
      this.result = c;
    }
    return this;
  };
  ...
  function Wa(a, c) {
    ...
    for (let d = 0, f; d < a.C.length; d++)
      if ((f = a.C[d]))
        if ("function" === typeof f) (b = f()), (a.C[d] = b = b.result || b), d--;
        else if (f.h) (b = f.h()), (a.C[d] = b = b.result || b), d--;
        else if (f.then) return a.await;
    const e = a.return;
    a.result = b;
    a.C = [];
    a.await = null;
  ...
  Y.prototype.resolve = function (a, c, b, e) {
    ...
    if (d.then) {
      return d.then(() => this.resolve(a, c, b));
    }
    d.length &&
      ("object" === typeof a && ((b = a.enrich), (c = a.offset), (a = a.limit)),
      (d = e ? (b ? Ta.call(this.index, d) : d) : Sa.call(this.index, d, a || 100, c, b)));
    e = this.return;
      ...
      for (let q = 0; q < h; q++)
        if (((t = a[q]), n < t.length && (u = t[n])))
          for (let y = 0; y < u.length; y++) {
            ...
            r.push(p);
            if (g && b && l === h - 1 && r.length - e === b) return e ? r.slice(e) : r;
          }
    if ((a = k.length))
      if (d)
        k =
  ...
  function db(a, c, b, e, d) {
    ...
    let k = d && d.boundary,
      m = !d || !1 !== d.clip,
      l = d && d.merge && h && g && new RegExp(h + " " + g, "g");
    d = d && d.ellipsis;
    var n = 0;
    if ("object" === typeof d) {
      var u = d.template;
    ...
    "object" === typeof k &&
      ...
      (k = k.total || 9e5));
    n = new Map();
    for (let Pa = 0, da, gb, oa; Pa < c.length; Pa++) {
      let pa;
      if (e) (pa = c), (oa = e);
      else {
        var r = c[Pa];
      ...
      da = gb.encoder;
      r = n.get(da);
      "string" !== typeof r && ((r = da.encode(a)), n.set(da, r));
      for (let xa = 0; xa < pa.length; xa++) {
        ...
        for (var C = 0; C < y.length; C++) {
          ...
          if (z && F) {
            var D = F.length,
              K = (da.split ? F.replace(da.split, "") : F).length - z.length,
              G = "",
              N = 0;
            ...
            G &&
              (k &&
                (0 > A && (A = q.length + (q ? 1 : 0)),
                (B = q.length + (q ? 1 : 0) + G.length),
                (E += D),
                ya.push(v.length),
                v.push({ match: G })),
              (q += (q ? " " : "") + G));
          }
          if (!x) (F = y[C]), (q += (q ? " " : "") + F), k && v.push({ text: F });
          else if (k && E >= k) break;
        }
        E = ya.length * (f.length - 2);
        if (p || t || (k && q.length - E > k))
          if (((E = k + E - 2 * u), (C = B - A), 0 < p && (C += p), 0 < t && (C += t), C <= E))
            (y = p ? A - (0 < p ? p : 0) : A - (((E - C) / 2) | 0)),
              (v = t ? B + (0 < t ? t : 0) : y + E),
              m ||
                (0 < y &&
                  " " !== q.charAt(y) &&
                  " " !== q.charAt(y - 1) &&
                  ((y = q.indexOf(" ", y)), 0 > y && (y = 0)),
                v < q.length &&
                  " " !== q.charAt(v - 1) &&
                  " " !== q.charAt(v) &&
                  ((v = q.lastIndexOf(" ", v)), v < B ? (v = B) : ++v)),
              (q = (y ? d : "") + q.substring(y, v) + (v < q.length ? d : ""));
          else {
            B = [];
            A = {};
            E = {};
                ...
                if (G)
                  if (K !== G) {
                    ...
                    if ((L = t && z[x]))
                      if (0 < L) {
                        if (q.length > L)
                          if (((C[x + 1] = 1), m)) q = q.substring(0, L);
                          else continue;
                        (L -= q.length) || (L = -1);
                        z[x] = L;
                      } else {
                    ...
                    if (D + q.length + 1 <= k) (q = " " + q), (B[x] += q);
                    else if (m)
                      (U = k - D - 1),
                        0 < U && ((q = " " + q.substring(0, U)), (B[x] += q)),
                        (C[x + 1] = 1);
                    else {
                      C[x + 1] = 1;
                      continue;
                    ...
                    if ((L = p && F[x]))
                      if (0 < L) {
                        if (q.length > L)
                          if (((C[x] = 1), m)) q = q.substring(q.length - L);
                          else continue;
                        (L -= q.length) || (L = -1);
                        F[x] = L;
                      } else {
                    ...
                    if (D + q.length + 1 <= k) (q += " "), (B[x] = q + B[x]);
                    else if (m)
                      (U = q.length + 1 - (k - D)),
                        0 <= U && U < q.length && ((q = q.substring(U) + " "), (B[x] = q + B[x])),
                        (C[x] = 1);
                    else {
                      C[x] = 1;
                      continue;
                  ...
                  J >= y.length - 1
                    ? (Qa = 1)
                    : J < v.length - 1 && v[J + 1].match
                      ? (Qa = 1)
                      : u && (D += u);
                  D -= f.length - 2;
                  if (!x || D + q.length <= k) B[x] = q;
                  else {
                    U = N = O = E[x] = 0;
                    break;
                  }
  ...
  Na.prototype.search = function (a, c, b, e) {
    ...
    if (b) {
      ...
      if (r && (!this.db || !e)) {
        ...
        for (let F = 0, z; F < r.length; F++)
          if (((z = r[F]), z.field && z.tag)) {
            var A = z.tag;
            if (A.constructor === Array) for (var B = 0; B < A.length; B++) v.push(z.field, A[B]);
            else v.push(z.field, A);
          } else {
            A = Object.keys(z);
            for (let D = 0, K, G; D < A.length; D++)
              if (((K = A[D]), (G = z[K]), G.constructor === Array))
                for (B = 0; B < G.length; B++) v.push(K, G[B]);
              else v.push(K, G);
          }
        r = v;
        if (!a) {
          ...
          if (v.length)
            for (r = 0; r < v.length; r += 2) {
              ...
              } else e = eb.call(this, v[r], v[r + 1], c, y, q);
              d.push(p ? { field: v[r], tag: v[r + 1], result: e } : [e]);
            }
          if (f.length) {
            return Promise.all(f).then((z) => {
              for (let D = 0; D < z.length; D++) p ? (d[D].result = z[D]) : (d[D] = z[D]);
      ...
      p ||
        ...
        (M(n)
          ? (g = n)
          : (n.constructor === Array && 1 === n.length && (n = n[0]), (g = n.field || n.index)));
    ...
    for (let F = 0, z, D, K; F < n.length; F++) {
      D = n[F];
      if (this.db && this.tag && !this.G[F]) continue;
      let G;
      M(D) ||
        ((G = D),
        (D = G.field),
        ...
        (y = aa(G.offset, y)),
        (k = aa(G.suggest, k)),
        (t = p && this.store && aa(G.highlight, t)),
        (q = !!t || (p && this.store && aa(G.enrich, q))),
        (l = aa(G.cache, l)));
      if (e) z = e[F];
      else {
        A = G || b || {};
        ...
        r &&
          (this.db && ((A.tag = r), (E = C.db.support_tag_search), (A.field = n)),
          !E && B && (A.enrich = !1));
        ...
        if (this.db && e) {
          if (!E)
            for (C = n.length; C < e.length; C++) {
              const N = e[C];
              if (N && N.length) B++, A.push(N);
              else if (!k) return p ? d : new Y(d, this);
            }
        } else
          for (let N = 0, O, P; N < r.length; N += 2) {
            O = this.tag.get(r[N]);
            if (!O)
              if (k) continue;
              else return p ? d : new Y(d, this);
            if ((P = (O = O && O.get(r[N + 1])) && O.length)) B++, A.push(O);
            else if (!k) return p ? d : new Y(d, this);
          }
        if (B) {
          z = cb(z, A, p);
          K = z.length;
          if (!K && !k) return p ? z : new Y(z, this);
          B--;
        }
      }
      if (K) (f[u] = D), d.push(z), u++;
      else if (1 === n.length) return p ? d : new Y(d, this);
    }
    if (v) {
      ...
      return Promise.all(v).then((z) => {
        b && (b.resolve = p);
        z.length && (z = this.search(a, c, b, z));
        return z;
      });
    }
    if (!u) return p ? d : new Y(d, this);
    if (g && (!q || !this.store)) return (d = d[0]), p ? d : new Y(d, this);
    v = [];
    for (y = 0; y < f.length; y++) {
      r = d[y];
      q &&
        r.length &&
        "undefined" === typeof r[0].doc &&
        (this.db
          ? v.push((r = this.index.get(this.field[0]).db.enrich(r)))
          : (r = Ta.call(this, r)));
      if (g) return p ? (t ? db(a, r, this.index, g, t) : r) : new Y(r, this);
      d[y] = { field: f[y], result: r };
    }
    if (q && this.db && v.length) {
      return Promise.all(v).then((z) => {
        for (let D = 0; D < z.length; D++) d[D].result = z[D];
  ...
  function fb(a) {
    ...
    for (let d = 0, f, g, h, k, m, l, n; d < a.length; d++) {
      ...
      for (let u = 0; u < h.length; u++)
        if (
          ((m = h[u]),
          "object" !== typeof m ? (m = { id: (k = m) }) : (k = m.id),
          (l = b[k]) ? l.push(g) : ((m.field = b[k] = [g]), c.push(m)),
          (n = m.highlight))
        )
  ...
  function Na(a) {
    ...
    this.reg =
      !this.fastupdate || a.worker || a.db ? (e ? new T(e) : new Set()) : e ? new S(e) : new Map();
    ...
    if ((b = c.tag))
      if (("string" === typeof b && (b = [b]), b.length)) {
        ...
        for (let d = 0, f, g; d < b.length; d++) {
          ...
          f.custom
            ? (this.F[d] = f.custom)
            : ((this.F[d] = hb(g, this.K)),
              f.filter &&
                ("string" === typeof this.F[d] && (this.F[d] = new String(this.F[d])),
                (this.F[d].J = f.filter)));
          this.P[d] = g;
    ...
    if (this.worker) {
      ...
      if (a.length) {
        return Promise.all(a).then((f) => {
          let g = 0;
          for (const h of this.index.entries()) {
            const k = h[0];
            let m = h[1];
            m.then && ((m = f[g]), this.index.set(k, m), g++);
          }
          return this;
        });
      }
  ...
  w.mount = function (a) {
    ...
    return (this.db = Promise.all(b).then(() => {
      this.db = !0;
    }));
  };
  w.commit = async function (a, c) {
    const b = [];
    for (const e of this.index.values()) b.push(e.commit(a, c));
    await Promise.all(b);
    this.reg.clear();
  };
  w.destroy = function () {
  ...
  function ib(a, c) {
    ...
    for (let f = 0, g, h; f < e.length; f++) {
      ...
      if (this.worker) {
        var d = void 0;
        d = (d = h.encoder) && d.encode ? d : new la("string" === typeof d ? va[d] : d || {});
        d = new La(h, d);
        b.set(g, d);
      }
      ...
      h.custom
        ? (this.G[f] = h.custom)
        : ((this.G[f] = hb(g, this.K)),
          h.filter &&
            ("string" === typeof this.G[f] && (this.G[f] = new String(this.G[f])),
            (this.G[f].J = h.filter)));
      this.field[f] = g;
    }
    if (this.D) {
      ...
      for (let f = 0, g, h; f < a.length; f++)
        (g = a[f]),
          (h = g.field || g),
          g.custom
            ? ((this.D[f] = g.custom), (g.custom.U = h))
            : ((this.D[f] = hb(h, this.K)),
              g.filter &&
                ("string" === typeof this.D[f] && (this.D[f] = new String(this.D[f])),
                (this.D[f].J = g.filter)));
    }
    return b;
  }
  function hb(a, c) {
    ...
    for (let d = 0; d < b.length; d++)
      (a = b[d]),
        "]" === a[a.length - 1] && (a = a.substring(0, a.length - 2)) && (c[e] = !0),
        a && (b[e++] = a);
  ...
  function pb(a) {
    let c = [],
      b = [];
    for (const e of a.keys()) b.push(e), 25e4 === b.length && (c.push(b), (b = []));
    b.length && c.push(b);
    return c;
  }
  function qb(a, c) {
  ...
  function rb(a, c, b, e, d, f, g = 0) {
    ...
    if ((k = a((c ? c + "." : "") + (g + 1) + "." + b, JSON.stringify(k))) && k.then) {
      return k.then(() => rb.call(this, a, c, b, h ? e : null, d, f, g + 1));
    }
  ...
  function jb(a, c, b = 0, e = 0) {
    if (b < this.field.length) {
      ...
      if ((c = this.index.get(g).export(a, g, b, (e = 1))) && c.then) {
        return c.then(() => this.export(a, g, b + 1));
      }
  ...
  function tb(a, c) {
    ...
    if (a.constructor === Array)
      for (let d = 0, f, g, h; d < a.length; d++) {
        if ((f = a[d]) && f.length) {
          ...
          g = f.indexOf(c);
          if (0 <= g) {
            if (1 < f.length) return f.splice(g, 1), 1;
            delete a[d];
            if (b) return 1;
            h = 1;
          } else {
    ...
    else for (const d of a.entries()) (e = d[0]), tb(d[1], c) ? b++ : a.delete(e);
    return b;
  }
  const vb = {
    memory: { resolution: 1 },
    ...
    if (c && (a || 0 === a)) {
      ...
      if (m) {
        ...
        for (let p = 0; p < m; p++) {
          ...
          var d = t.length;
          if (d && (e || !n[t])) {
            var f = this.score ? this.score(c, t, p, null, 0) : wb(u, m, p),
              g = "";
                ...
                if ((xb(this, n, t, f, a, b), e && 1 < m && p < m - 1))
                  for (
                    d = I(),
                      g = this.T,
                      f = t,
                      h = Math.min(e + 1, this.rtl ? p + 1 : m - p),
                      d[f] = 1,
                      k = 1;
                    k < h;
                    k++
                    ...
                    if ((t = c[this.rtl ? m - 1 - p - k : p + k]) && !d[t]) {
                      d[t] = 1;
                      const r = this.score
                          ? this.score(c, f, p, t, k - 1)
                          : wb(g + (m / 2 > g ? 0 : 1), m, p, h - 1, k - 1),
                        q = this.bidirectional && t > f;
    ...
    if (!c[b] || (g && !(k = c[b])[g]))
      if (
        (g
          ? ((c = k || (c[b] = I())),
            (c[g] = 1),
            (k = h.get(g)) ? (h = k) : h.set(g, (h = new Map())))
          : (c[b] = 1),
        ...
        if (h.length === 2 ** 31 - 1) {
          c = new za(h);
          if (a.fastupdate) for (const m of a.reg.values()) m.includes(h) && (m[m.indexOf(h)] = c);
          k[e] = h = c;
        }
        h.push(d);
  ...
  V.prototype.search = function (a, c, b) {
    ...
    b &&
      ...
      (f = b.context),
      (g = b.suggest),
      (u = (k = b.resolve) && b.enrich),
      (l = b.boost),
      (n = b.resolution),
      (m = this.db && b.tag));
    "undefined" === typeof k && (k = this.resolve);
    f = this.depth && !1 !== f;
    const p = this.encoder.encode(a, !f);
    d = p.length;
    c = c || (k ? 100 : 0);
    if (1 === d) return yb.call(this, p[0], "", c, h, k, u, m);
    if (2 === d && f && !g) return yb.call(this, p[1], p[0], c, h, k, u, m);
    let t = I(),
      r = 0,
      q;
    f && ((q = p[0]), (r = 1));
    ...
    if (this.db) {
      if (this.db.search && ((b = this.db.search(this, p, c, h, g, k, u, m)), !1 !== b)) return b;
      return (async () => {
        for (let v, A; r < d; r++) {
          if ((A = p[r]) && !t[A]) {
            t[A] = 1;
            v = await zb(this, A, q, 0, 0, !1, !1);
            if ((v = Ab(v, e, g, n))) {
              e = v;
              break;
            }
  ...
  function Bb(a, c, b, e, d, f, g) {
    let h = a.length,
      k = a;
    if (1 < h) k = $a(a, c, b, e, d, f, g);
    else if (1 === h) return g ? Sa.call(null, a[0], b, e) : new Y(a[0], this);
  ...
  function V(a, c) {
    if (!this || this.constructor !== V) return new V(a);
    if (a) {
      var b = M(a) ? a : a.preset;
      b && (a = Object.assign({}, vb[b], a));
    } else a = {};
    b = a.context;
    const e = !0 === b ? { depth: 1 } : b || {},
      d = M(a.encoder) ? va[a.encoder] : a.encode || a.encoder || {};
  ...
  w.update = function (a, c) {
    const e = this.remove(a);
    return e && e.then ? e.then(() => this.add(a, c)) : this.add(a, c);
  };
  w.cleanup = function () {
  ...
  const Cb =
    ...
    Db = ["map", "ctx", "tag", "reg", "cfg"],
    Eb = I();
  function Fb(a, c = {}) {
    if (!this || this.constructor !== Fb) return new Fb(a, c);
    ...
    c.onupgradeneeded = function () {
      ...
      for (let e = 0, d; e < Db.length; e++) {
        ...
        for (let f = 0, g; f < Eb[a.id].length; f++)
          (g = Eb[a.id][f]),
            b.objectStoreNames.contains(d + ("reg" !== d ? (g ? ":" + g : "") : "")) ||
              b.createObjectStore(d + ("reg" !== d ? (g ? ":" + g : "") : ""));
      }
    };
    return (a.db = Z(c, (b) => {
      a.db = b;
  ...
  w.get = function (a, c, b = 0, e = 0, d = !0, f = !1) {
    a = this.db
      .transaction((c ? "ctx" : "map") + (this.field ? ":" + this.field : ""), "readonly")
      .objectStore((c ? "ctx" : "map") + (this.field ? ":" + this.field : ""))
      .get(c ? c + ":" + a : a);
    return Z(a).then((h) => {
      const k = [];
      if (!h || !h.length) return k;
      if (d) {
        if (!b && !e && 1 === h.length) return h[0];
        for (let m = 0, l; m < h.length; m++)
          if ((l = h[m]) && l.length) {
            ...
            for (let u = e; u < n; u++) k.push(l[u]);
            e = 0;
            if (k.length === b) break;
          }
        return f ? this.enrich(k) : k;
      }
      return h;
    });
  };
  w.tag = function (a, c = 0, b = 0, e = !1) {
    ...
    return Z(a).then((f) => {
      ...
      if (!c && !b) return f;
      f = f.slice(b, b + c);
      return e ? this.enrich(f) : f;
    });
  };
  w.enrich = function (a) {
    "object" !== typeof a && (a = [a]);
    const c = this.db.transaction("reg", "readonly").objectStore("reg"),
      b = [];
  ...
  w.commit = async function (a, c, b) {
    if (c) await this.clear(), (a.commit_task = []);
    else {
      let e = a.commit_task;
      a.commit_task = [];
    ...
    a.reg.size &&
      (await this.transaction("map", "readwrite", (e) => {
              ...
              : (e.get(f).onsuccess = function () {
                  ...
                  if (h && h.length) {
                    ...
                    for (let l = 0, n, u; l < m; l++)
                      if ((u = g[l]) && u.length) {
                        if ((n = h[l]) && n.length) for (k = 0; k < u.length; k++) n.push(u[k]);
                        else h[l] = u;
                        k = 1;
                      }
                  } else (h = g), (k = 1);
      ...
      await this.transaction("ctx", "readwrite", (e) => {
                ...
                : (e.get(f + ":" + k).onsuccess = function () {
                    ...
                    if (l && l.length) {
                      ...
                      for (let p = 0, t, r; p < u; p++)
                        if ((r = m[p]) && r.length) {
                          if ((t = l[p]) && t.length) for (n = 0; n < r.length; n++) t.push(r[n]);
                          else l[p] = r;
                          n = 1;
                        }
                    } else (l = m), (n = 1);
      ...
      a.store
        ? await this.transaction("reg", "readwrite", (e) => {
      ...
      a.tag &&
        (await this.transaction("tag", "readwrite", (e) => {
      ...
      if ((h = b ? e : e[g])) {
        for (let k = 0, m, l; k < c.length; k++)
          if (((l = c[k]), (m = h.indexOf(l)), 0 <= m))
            if (((d = 1), 1 < h.length)) h.splice(m, 1);
            else {
              e[g] = [];
              break;
            }
  ...
  w.remove = function (a) {
    "object" !== typeof a && (a = [a]);
    return Promise.all([
      this.transaction("map", "readwrite", (c) => {
        c.openCursor().onsuccess = function () {
          const b = this.result;
          b && Gb(b, a);
        };
      }),
      this.transaction("ctx", "readwrite", (c) => {
        c.openCursor().onsuccess = function () {
          const b = this.result;
          b && Gb(b, a);
        };
      }),
      this.transaction("tag", "readwrite", (c) => {
        c.openCursor().onsuccess = function () {
          const b = this.result;
          b && Gb(b, a, !0);
        };
      }),
      this.transaction("reg", "readwrite", (c) => {
  ...
  const Hb = {
    ...
    Ib = "undefined" !== typeof self ? self : "undefined" !== typeof global ? global : self;
  let Jb;
  (Jb = Ib.define) && Jb.amd
    ? Jb([], () => Hb)
    : "object" === typeof Ib.exports
      ? (Ib.exports = Hb)
      : (Ib.FlexSearch = Hb);
})(this || self);
